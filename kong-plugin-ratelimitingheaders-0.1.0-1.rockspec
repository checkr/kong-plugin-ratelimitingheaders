...
package = "kong-plugin-ratelimitingheaders"
...
source = {
  url = "git://github.com/checkr/kong-plugin-ratelimitingheaders",
  tag = "0.1.0"
}

description = {
  summary = "ratelimitingheaders overrides some headers from rate limiting"
}
